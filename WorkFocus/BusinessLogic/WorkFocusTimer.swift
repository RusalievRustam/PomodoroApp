...
enum WorkFocusTimerState: String {
  case idle
  case running
  case paused
}

enum WorkFocusTimerMode: String {
  case work
  case pause
...
class WorkFocusTimer {
  ...
  // helper functions
    ...
    private var _mode: WorkFocusTimerMode = .work
  private var _state: WorkFocusTimerState = .idle
  ...
  private var _timer: Timer?
    private var _audio: WorkFocusAudio = WorkFocusAudio()
  ...
  var fractionLeft: Double {
    ...
    var state: WorkFocusTimerState {
    _state
  }
  var mode: WorkFocusTimerMode {
    _mode
  }
  ...
  private func _createTimer() {
    // schedule notification
      WorkFocusNotification.scheduleNotification(seconds: TimeInterval(secondsLeft), title: "Timer Done", body: "Your pomodoro timer is finished.")
    // create timer
